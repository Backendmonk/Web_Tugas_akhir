  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input class="form-control mb-2" name="pass1" type="text"  placeholder="Password Baru" >
        <input class="form-control mb-2" name="pass2" type="text"  placeholder="Konfirmasi Password" >
