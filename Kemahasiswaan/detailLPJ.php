                        ...
                        <div class="card-header py-3">
                           ...
                           <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['pelaksanaan_kegaitan'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                </tr>

                                <tr>
                                    <th>Kepanitiaan</th>
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['kepanitiaan'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                </tr>

                                <tr>
                                    <th>Peserta</th>
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['peserta'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                </tr>
                                <tr>

                                    <th>RAB Pemasukan</th>
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['rab_masukan'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                </tr>

                                <tr>
                                    <th>RAB Pengeluaran</th>
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['rab_pengeluaran'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['realisasi_anggaran'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['bukti_pembayaran'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                </tr>

                                <tr>
                                    <th>Berita Acara</th>
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['berita_acara'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                ...
                                <tr>
                                    <th>Absensi</th>
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['absensi'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['rapat'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['nilai_peserta'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['desain_sertifikat'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                ...
                                <tr>
                                    <th>Softcopy LPJ</th>
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/f_lpj/".$arr['LPJ'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
