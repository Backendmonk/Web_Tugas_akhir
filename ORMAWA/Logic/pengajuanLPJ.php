          ...
          header("location:../pengajuanLPJ.php");
                ...
                if(isset($_POST['edit'])){
                   ...
                   // konsep kegiatan
                    ...
                    $sqlLPJ = "UPDATE pengajuan_lpj set pendahuluan = '$pdln', pelaksanaan_kegaitan = '$pk', kepanitiaan = '$kepan', peserta = '$peser', pencapaian = '$penca', rab_masukan = '$rabin', rab_pengeluaran = '$rabout', realisasi_anggaran = '$rp', penutup = '$ttp', bukti_pembayaran = '$bp', berita_acara = '$ba', absensi = '$absen', rapat = '$nr', nilai_peserta = '$rpp', desain_sertifikat = '$ds', dokumentasi = '$dk', LPJ = '$slpj' where id = '$id'";

                    mysqli_query($koneksi,"UPDATE applpj SET 
                    approve = NULL WHERE idlpj = '$id'");
                      //insert query
                      ...
                      header("location:../pelaporan_kegiatan.php");
                            }
