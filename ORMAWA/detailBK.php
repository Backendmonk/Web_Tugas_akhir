                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <form action="Logic/BuktiKegiatan.php" method="post" class="row g-3" >
                           <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><button type="button" class="btn btn-primary"> <a style="text-decoration:none; Color:white;" href="<?php echo "../Ormawa/lpj/".$arr['bukti'] ?>"> <i class = "fa fa-download"></i> </a> </button></td>
                                </tr>
                                <?php 
                                    $idlpj = $arr['id'];
