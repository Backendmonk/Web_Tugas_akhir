...
<?php include 'template/navbar.php' ?>
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control" readonly id="inputPassword4" value = "<?php echo $arr['nama_ormawa']; ?>" name="nama_ormawa">
  ...
  <div class="col-md-6">
    ...
    <input type="text" value="<?= $arr['nama_kegiatan'] ?>" class="form-control" id="inputEmail4" name = "nama_kegiatan">
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Tema Kegiatan</label>
    <input value="<?= $arr['tema_kegiatan'] ?>" type="text" class="form-control" id="inputEmail4" name = "tema_kegiatan">
  </div>
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Konsep Kegiatan</label>
    
    <textarea class="form-control" name="konsep" rows="4" cols="50"><?= $arr['konsep_kegiatan'] ?></textarea>
  </div>

  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Sub Kegiatan</label>
    
    <textarea class="form-control" name="subkegiatan" rows="4" cols="50"><?= $arr['sub_kegiatan'] ?></textarea>
  </div>

  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Pj Kegiatan</label>
    
    <textarea class="form-control" name="pj" rows="4" cols="50"><?= $arr['pj_kegiatan'] ?></textarea>
  </div>

  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Latar Belakang</label>
    
    <textarea class="form-control" name="latarbelakang" rows="4" cols="50"><?= $arr['latar_belakang'] ?></textarea>
  </div>

  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Tujuan Kegiatan</label>
    
    <textarea class="form-control" name="tujuan" rows="4" cols="50"><?= $arr['tujuan_kegiatan'] ?></textarea>
  </div>
  ...
  <div class="col-md-6">
    ...
    <textarea class="form-control" name="harapan" rows="4" cols="50"><?= $arr['hasil_harapan'] ?></textarea>
  </div>
  
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Target Pemasaran</label>
    
    <textarea class="form-control" name="target" rows="4" cols="50"><?= $arr['targer_pemasaran'] ?></textarea>
  </div>
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['Tanggal'] ?>" type="date" class="form-control" name="tanggal">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['Waktu'] ?>" type="time" class="form-control" name="waktu">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['Tempat'] ?>" type="text" class="form-control" name="tempat">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['sk_kepanitiaan'] ?>"  type="file" class="form-control" name="sk">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['jadwal_kegiatan'] ?>" type="file" class="form-control" name="jadwal">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['rab'] ?>" type="file" class="form-control" name="rab">
  ...
  <div class="col-md-6">
    ...
    <input value="" type="file" class="form-control" name="renja">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['profile_pengisi_acara'] ?>" type="file" class="form-control" name="profile">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['desain_poster_sertifikat'] ?>" type="file" class="form-control" name="poster">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['ketua_panitia'] ?>" type="text" class="form-control" name="ketua">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['contac_person'] ?>" type="text" class="form-control" name="contac">
  ...
  <div class="col-md-6">
    ...
    <input value="<?= $arr['softcopy_proposal'] ?>" type="file" class="form-control" name="proposal">
...
<?php 
    require 'Template/EditProfilePass.php';
      ...
      if(isset($_POST['ajukan'])){
        ...
        $sql = "UPDATE pengajuan_kegiatan_mhs SET nama_kegiatan = '$nama_kegiatan', `tema_kegiatan` = '$tema_kegiatan', `konsep_kegiatan` = '$konsep',  `sub_kegiatan`= '$sub_kegiatan', `pj_kegiatan` = '$pj', `latar_belakang` = '$latar_belakang',  `tujuan_kegiatan` = '$tujuan', `hasil_harapan` = '$hasil', `targer_pemasaran` = '$target', `Tanggal`= '$tanggal', `Waktu`= '$waktu', `Tempat`='$tempat', `sk_kepanitiaan`= '$sk', `jadwal_kegiatan` = '$jadwal', `rab` = '$rab', `profile_pengisi_acara` = '$profile', `desain_poster_sertifikat` = '$poster' , `ketua_panitia`= '$ketua',  `contac_person` = '$contac', `softcopy_proposal` = '$proposal' where id = '$idpe' ";
        

        mysqli_query($koneksi,$sql);
    
        $sqlp = "UPDATE approval_kegiatan SET status = 'Pending' where id_pengajuan = $idpe";
            mysqli_query($koneksi,$sqlp);
