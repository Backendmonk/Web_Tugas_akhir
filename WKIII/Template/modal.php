  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input class="form-control mb-2" name="NIDN" type="text" value="<?= $array['NIDN_WKIII']?>"   placeholder="Default input" required hidden>
        <input class="form-control mb-2" type="text" value="<?= $array['NIDN_WKIII']?>"   placeholder="Default input" required disabled>
        <input class="form-control mb-2" name="NAMA" type="text" value="<?= $array['NAMA_WKIII']?>" placeholder="Default input" required>
        <input class="form-control mb-2" name="Jabatan" type="text" value="<?= $array['JABATAN_WKIII']?>"  placeholder="Default input" required>
      </div>
      <div class="modal-footer">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" method="post">
        <input class="form-control mb-2" name="NIDN"type="text" value="<?= $array['NIDN_WKIII']?>"   placeholder="Default input" required hidden>
        <input  hidden class="form-control mb-2" name="pass"type="password" value="<?= $array['PASSWORD_WKIII']?>"   placeholder="Default input" required >
