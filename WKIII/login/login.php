        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <h4 style=" color: #e6e6e6; " class="mb-4">WKIII</h4>
            </div>
...
<?php
      if(isset($_POST['flog'])){
        ...
        error_reporting(0);
        $qlog = mysqli_query($koneksi,"SELECT * FROM `wkiii` where `NIDN_WKIII` = '$nidn' ");
        ...
        if ($rows ==  1) {
					if (password_verify($password,$arr['PASSWORD_WKIII'])) {

						session_start();
						$_SESSION['userweb_wkiii'] = $arr['NIDN_WKIII'];
						header("Location: ../Home-WKIII.php");
						}
